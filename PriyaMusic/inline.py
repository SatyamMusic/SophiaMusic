...
def audio_markup(user_id):
  buttons = [
    [
      InlineKeyboardButton(text="● sᴜᴘᴘᴏʀᴛ ●", url=f"https://t.me/AM_YTSUPPORT"),
      InlineKeyboardButton(text="● ᴜᴘᴅᴀᴛᴇs ●", url=f"https://t.me/AMBOTYT"),
    ],
    [
...
def menu_markup(user_id):
  buttons = [
     ...
     [InlineKeyboardButton(text="🔇", callback_data=f'cbmute | {user_id}'),
      InlineKeyboardButton(text="ᴜᴩᴅᴀᴛᴇs", url=f"https://t.me/AMBOTYT"),
